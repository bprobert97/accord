...
def run_benchmark():
   ...
   # Plot 1: Cumulative Drift
    ...
    axes[0].set_xlabel("Orbit Step [-]", fontsize=18)
    axes[0].set_ylabel("Cumulative Drift [km]", fontsize=18)
    ...
    axes[1].set_xlabel("Orbit Step [-]", fontsize=18)
    axes[1].set_ylabel("Reputation [-]", fontsize=18)
    axes[1].tick_params(axis='both', which='major', labelsize=16)
    axes[1].legend(loc="upper left", bbox_to_anchor=(0.05, 0.98), fontsize=16)
    axes[1].grid(True)
